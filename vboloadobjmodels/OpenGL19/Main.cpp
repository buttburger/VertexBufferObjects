...
GLuint vertexbuffer, vertexbuffer1;
GLuint colorbuffer, colorbuffer1;
GLuint uvbuffer, uvbuffer1;
GLuint normalbuffer, normalbuffer1;
GLuint elementbuffer, elementbuffer1;
...
///////////////////////////////////////
std::vector<glm::vec3> vectorvertices1;
std::vector<glm::vec2> vectoruvs1;
std::vector<glm::vec3> vectornormals1;
//int verticevectorsize;
...
void display()
{
	...
	*/
	...
	glDrawElements(GL_TRIANGLES, indices1.size(), GL_UNSIGNED_SHORT, (void*)0);
	//glDrawArrays(GL_TRIANGLES, 0, vectorvertices.size() * sizeof(glm::vec3));
...
void initGL()
{
	...
	if(GLEW_ARB_vertex_shader && GLEW_ARB_fragment_shader && GL_EXT_geometry_shader4)
	{
		...
		bool res = loadOBJ("maya.obj", vectorvertices, vectoruvs, vectornormals);
		...
		*/
		...
		////////////////////////////////////////////////////
		bool res1 = loadOBJ("monkey.obj", vectorvertices1, vectoruvs1, vectornormals1);
		indexVBO(vectorvertices1, vectoruvs1, vectornormals1, indices1, indexed_vertices1, indexed_uvs1, indexed_normals1);
		//vertex
		...
		*/
		...
		int width, height;
		bool hasAlpha;
		char filename[] = "mayatexture.png", filename1[] = "monkeytexture.png";
